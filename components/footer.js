      ...
      <Container>
        ...
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
          <div class="d-flex align-items-center">
            ...
            {/*</a> */}
            <span class="mb-4 mb-md-0 text-muted">Copyright &copy; 1982 - {currentYear} <a href="/">Michael Youngblood</a>. All rights reserved.</span>
          </div>
          ...
          <ul class="nav col-md-3 justify-content-end list-unstyled d-flex">
            ...
            <li class="ms-3"><Link className="text-muted" href="https://github.com/aliendev/Michael-Youngblood_com"><Github title='Code Repo for Michael-Youngblood.com' className='align-text-top' /> Code Repo</Link></li>
          </ul>
